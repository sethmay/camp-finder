...
- `PENDING` Cover the 34 Tentaroo councils by agent-assisted extraction (Tentaroo itself is
  ...
  confidence 0.6, human-reviewed + fee spot-checks). Camp count 69 -> 104. 3 councils have no
  resident camp, 2 uncertain excluded, 13 camps lack precise coords (listed, not mapped).
