...
def test_signature_matches():
    ...
    # scoutingevent (registration) wins over a doubleknot CMS reference on the same page
    m = '<a href="scoutingevent.com/047">r</a><iframe src="doubleknot.com/x">'
    assert detect_from_html(m) is Platform.blackpug
