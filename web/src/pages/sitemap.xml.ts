...
// step with this Astro line and crashes. This lists the static routes, the region and state
// landing pages, and one URL per camp — all enumerated from the same camps.json the pages build from.
...
const STATIC_PATHS = ["/", "/about/", "/compare/", "/regions/", "/states/"];
